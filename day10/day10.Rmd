---
title: "Univariate Genomic prediction"
...
---
# Longitudinal data
Predict time 2 response from time 1; predict time 3 response from time 1, etc
<div align="center">
...
&=  Cov(\mathbf{X}\mathbf{a}, \mathbf{y}^T)\cdot \mathbf{V}_y^{-1}  \mathbf{y}  \notag \\
...
We arrive at the  same prediction regardless of whether we start from the genotype matrix $\mathbf{W}$ or from the $\mathbf{g}$ 
