...
This is how the `PlantGrowth` data set looks like.  
...
### Exercise
Compute the mean of plant growth when under `trt1` condition. 
...
### Exercise
Find out how many plants produced yields greater than 5 regardelss of group type. 
...
### Covariance
The `cov` function computes the covariance of two vectors. Covariance between yields under two different treatment conditions is the following. 
...
### Correlation
The `cor` function computes the correlation of two vectors. Correlation between yields under two different treatment conditions is the following. 
